...
public interface SqlQueryService {
	...
	<TEntity> List<TEntity> findAllByQueryNativeToEntity(final Class<TEntity> eClazz, final String queryNative,
			final Object... params);
	...
	<TEntity> List<TEntity> findByCriteria(final DetachedCriteria criteria, final Integer firstResult,
