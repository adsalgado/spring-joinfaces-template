...
public class AppMenu {
	...
	public void init() {
		 ...
		 * calendarMenuItems.add(new MenuItem("Date (java.util.Date)",
		 ...
		 * MenuItem("Calendar", calendarMenuItems));
		 */
		...
		// dataTableMenuItems.add(new MenuItem("SubTable",
		// "/ui/data/datatable/subTable"));
		// dataTableMenuItems.add(new MenuItem("SummaryRow",
		// "/ui/data/datatable/summaryRow"));
